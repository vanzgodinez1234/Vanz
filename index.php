 ...
 <head> 
 	     ...
 	     <link rel="stylesheet" type="text/css" href="../vannette/css/style.css"> 
 </head> 
 <body> 
 	  <div class="mainBase">
 	  	 <div class="centerBaseGrey"> 
 	  	        <div class="headerBase">
 	  	        </div>
 	  	        <div>
 	  	        	<h3>Router</h3>
 	  	        	<img src="../vannette/images/router1.jpg">
 	  	        	<p> 
 	  	    		...
 	  	    		<h3>PC</h3>
 	  	    		<img src="../vannette/images/pc.jpg">
 	  	        	<p> 
 	  	    		...
 	  	    		<h3>RJ45</h3>
 	  	    		<img src="../vannette/images/rg45.jpg">
 	  	        	<p> 
 	  	    		...
 	  	    		<h3>Modem</h3>
 	  	    		<img src="../vannette/images/modem.png">
 	  	        	<p> 
 	  	    		...
 	  	    		<h3>Reapeter</h3>
 	  	    		<img src="../vannette/images/repeater.jpg">
 	  	        	<p> 
 	  	    		...
 	  	    		<h3>Hub</h3>
 	  	    		<img src="../vannette/images/hub.jpg">
 	  	        	<p> 
 	  	        		Hub, also called a network hub, is a common connection point for devices in a network. Hubs are devices commonly used to connect segments of a LAN. The hub contains multiple ports. When a packet arrives at one port, it is copied to the other ports so that all segments of the LAN can see all packets.
 	  	    		</p>

 	  	    		<h3>Switch</h3>
 	  	    		<img src="../vannette/images/switch.jpg">
 	  	        	<p> 
 	  	        		A network switch (also called switching hub, bridging hub, officially MAC bridge) is a computer networking device that connects devices together on a computer network by using packet switching to receive, process, and forward data to the destination device.  
 	  	    		</p>

 	  	    		<h3>Connectors</h3>
 	  	    		<img src="../vannette/images/connectors.jpg">
 	  	        	<p> 
 	  	        		A connector is the part on a cable or an appliance that has female contact pins and is intended to be attached to the end of the flexible cable remote from the supply.
  
 	  	    		</p>

 	  	    		<h3>Crimper</h3>
 	  	    		<img src="../vannette/images/crimper.jpg">
 	  	        	<p> 
